...
if not os.path.exists("checkpoints/best_checkpoint_CNNBatchNorm_augmented.tar"):
    utils.run_cifar_training(model, optimizer,
            train_loader, val_loader,
            device=device, name='CNNBatchNorm_augmented', 
            n_epochs=n_epochs)

model = utils.load_checkpoint("best_checkpoint_CNNBatchNorm_augmented.tar", model, optimizer)[0]
